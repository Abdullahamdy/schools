        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <button type="button" class="button x-small" data-toggle="modal" data-target="#exampleModal">
                    {{ trans('myClasses_trans.add_classroom') }}
                </button>

                    <button type="button" class="button x-small" id="btn_delete_all">
                        {{ trans('myClasses_trans.delete_checkbox') }}
                    </button>
                ...
                <br><br>
                    ...
                    <form action="{{route("Filter_Class")}}" method="POST">
                        ...
                        <select class="selectpicker" data-style="btn-info" name="Grade_id" required
                            ...
                            <option value="" selected disabled>{{ trans('myClasses_trans.Search_By_Grade') }}</option>
                    ...
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>#</th>
                                <th>{{ trans('myClasses_trans.Name_class') }}</th>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('Classrooms.update', 'test') }}" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for="Name"
                                                                   class="mr-sm-2">{{ trans('myClasses_trans.Name_class') }}
                                                                :</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleFormControlTextarea1">{{ trans('Grade_trans.tittle_page') }}
                                                            :</label>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">
                        {{ trans('myClasses_trans.page_tittle') }}
                    </h5>
                    ...
                    <form class=" row mb-30" action="{{ route('Classrooms.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="repeater">
                                ...
                                <div data-repeater-list="List_Classes">
                                    ...
                                    <div data-repeater-item>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <label for="Name_en"
                                                    class="mr-sm-2">{{ trans('Grade_trans.name') }}
                                                    :</label>
                                            ...
                                            <div class="col">
                                                <label for="Name_en"
                                                    class="mr-sm-2">{{ trans('Grade_trans.processes') }}
                                                    :</label>
                                ...
                                <div class="row mt-20">
                                    <div class="col-12">
                                        <input class="button" data-repeater-create type="button" value="{{ trans('myClasses_trans.add_row') }}"/>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit"
                                        class="btn btn-success">{{ trans('myClasses_trans.submit') }}</button>
                                </div>
