        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#elements">
                            <div class="pull-left"><i class="ti-palette"></i><span
                                    class="right-nav-text">{{trans('main-trans.Grade')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('Grades.index')}}">{{trans('main-trans.Grade_list')}}</a></li>
                        </ul>
                    </li>
                    <!-- menu item calendar-->
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{ trans('myClasses_trans.list_classrooms') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route("Classrooms.index")}}">{{ trans('myClasses_trans.list_classrooms') }} </a> </li>

                        </ul>
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="calendar.html">{{ trans('myClasses_trans.add_classroom') }} </a> </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menus">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{ trans('parent.tittle') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-menus" class="collapse" data-parent="#sidebarnav">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menuss">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{ trans('المعلمين') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-menuss" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{Url("Teachers")}}">{{ trans('اضافه معلم') }} </a> </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-student">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{ trans('الطلاب') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-student" class="collapse" data-parent="#sidebarnav">

                            <li> <a href="{{route("students.create")}}">{{ trans('اضافه طالب') }} </a> </li>
                            <li> <a href="{{route("students.index")}}">{{ trans('قائمه الطلاب') }} </a> </li>
                            <li> <a href="{{route("Graduated.create")}}">{{ trans('تخرج جديد ') }} </a> </li>
                            <li> <a href="{{route("Graduated.index")}}">{{ trans('قائمه الطلاب المتخرجين') }} </a> </li>
                        </ul>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-Fees">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{ trans('الحسابات') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-Fees" class="collapse" data-parent="#sidebarnav">

                            <li> <a href="{{route("Fees.index")}}">{{ trans(' عرض الحسابات') }} </a> </li>
                        </ul>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#promotion-student">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{ trans('ترقيه الطلاب') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="promotion-student" class="collapse" data-parent="#sidebarnav">

                            <li> <a href="{{route("Promotion.index")}}">{{ trans(' ترقيه الطلاب') }} </a> </li>
                            <li> <a href="{{route("Promotion.create")}}">{{ trans(' اداره ترقيه الطلاب') }} </a> </li>
                    ...
                    <!-- menu item todo-->
                    <li>
                        <a href="{{route('Sections.index')}}"><i class="ti-menu-alt"></i><span class="right-nav-text">{{ trans('section.tittle_sidebar') }}
                                </span> </a>
                    </li>
                    <!-- menu item chat-->
                    <li>
