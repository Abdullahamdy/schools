...
class AddParent extends Component
{
    ...
    $catchError,$show_table=true,$Parent_id,
    $successMessage ='',
    $updateMode = false,
    $Email, $Password,
    ...
    $Address_Father, $Religion_Father_id,$photos,
      //Mother
...
public function updated($propertyName){
    ...
    public function render()
    {
        return view('livewire.add-parent',[
            'Nationalities'=>Nationalties::all(),
        ...
        try{
            ...
            if(!empty($this->photos)){
                foreach($this->photos as $photo){
                    $photo->storeAs($this->National_ID_Father,$photo->getClientOriginalName(),$disk='parent_attchements');
...
public function submitFormeEdit(){
    //parent_id from button in the table show
      if($this->Parent_id){
